  ...
  <div class="container">
    <Form ref="formInline" :model="formInline" :rules="ruleInline" inline>
      <FormItem prop="account">
        <Input type="text" v-model="formInline.account" placeholder="通知名称">
      ...
      <FormItem>
        <Button type="primary" @click="modal1 = true">新添通知</Button>
      </FormItem>
    </Form>
...
<script type="es6">
  export default {
              ...
              return h('div', [
                ...
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.modal2=true
                      this.currDelBtId=params.row.nid
    ...
    methods: {
      ...
      request (currentPage){
        var that=this
        this.$http.post(that.GLOBAL.serverPath + '/super/getAllNotices',
          {
      ...
      ok (name) {
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            that.$http.post(that.GLOBAL.serverPath + '/super/addNotice',
              {
      ...
      ok2(){
        console.log("..............................")
        var that=this
        this.$http.post(that.GLOBAL.serverPath + '/super/delNotice',
          {
            nid: that.currDelBtId,
          },
          {
            emulateJSON: true
          }
